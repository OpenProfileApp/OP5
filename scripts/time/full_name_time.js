document.addEventListener('DOMContentLoaded', function() {
  const textInput = document.getElementById('full_name');
  const writtenDateInput = document.getElementById('written_date');
  const lastModified = document.getElementById('full_name_time');
  const targetElement = document.getElementById('full_name'); // Change 'target_element' to the actual ID of the element you want to modify
