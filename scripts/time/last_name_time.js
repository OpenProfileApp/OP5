document.addEventListener('DOMContentLoaded', function() {
  const textInput = document.getElementById('last_name');
  const writtenDateInput = document.getElementById('written_date');
  const lastModified = document.getElementById('last_name_time');
  const targetElement = document.getElementById('last_name'); // Change 'target_element' to the actual ID of the element you want to modify
