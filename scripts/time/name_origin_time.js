document.addEventListener('DOMContentLoaded', function() {
  const textInput = document.getElementById('name_origin');
  const writtenDateInput = document.getElementById('written_date');
  const lastModified = document.getElementById('name_origin_time');
  const targetElement = document.getElementById('name_origin'); // Change 'target_element' to the actual ID of the element you want to modify
