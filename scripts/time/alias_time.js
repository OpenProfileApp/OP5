document.addEventListener('DOMContentLoaded', function() {
  const textInput = document.getElementById('alias');
  const writtenDateInput = document.getElementById('written_date');
  const lastModified = document.getElementById('alias_time');
  const targetElement = document.getElementById('alias'); // Change 'target_element' to the actual ID of the element you want to modify
