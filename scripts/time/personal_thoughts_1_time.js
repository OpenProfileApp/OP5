document.addEventListener('DOMContentLoaded', function() {
  const textInput = document.getElementById('personal_thoughts_1');
  const writtenDateInput = document.getElementById('written_date');
  const lastModified = document.getElementById('personal_thoughts_1_time');
  const targetElement = document.getElementById('personal_thoughts_1'); // Change 'target_element' to the actual ID of the element you want to modify
