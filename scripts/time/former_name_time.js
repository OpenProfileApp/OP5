document.addEventListener('DOMContentLoaded', function() {
  const textInput = document.getElementById('former_name');
  const writtenDateInput = document.getElementById('written_date');
  const lastModified = document.getElementById('former_name_time');
  const targetElement = document.getElementById('former_name'); // Change 'target_element' to the actual ID of the element you want to modify
